...
public class BikeMapActivity extends FragmentActivity implements OnMapReadyCallback {
////
...
//      Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(-8.065638, -34.891130);
